...
* **当使用文档里面描述的功能的时候，请检查已部署的代码版本是否太旧没有新功能**
...
* 2022-8-6公告：腾讯云函数日志开始收费，请在[此处](https://console.cloud.tencent.com/cls/overview)删除所有`日志主题`。并将所有云函数的函数配置中的`日志投递`取消。
  ...
  > <img src="README.assets/2022-08-06-21-35-53-001.png" alt="2022-08-06-21-35-53-001" style="zoom: 80%;" />
  
* `3.9.1a`2022-8-18公告：修复信息收集获取表单失败的问题（感谢scrpr提交的PR）
