* 因为**疫情结束**和**学业繁忙**原因，本仓库于2023年6月7日进入存档状态（**停止维护**）。
* 因为**疫情结束**和**学业繁忙**原因，本仓库于2023年6月7日进入存档状态（**停止维护**）。
* 因为**疫情结束**和**学业繁忙**原因，本仓库于2023年6月7日进入存档状态（**停止维护**）。

# 滕王阁序![有些github上的在线图片没有正常加载, 请检查代理](https://raw.githubusercontent.com/IceTiki/picbed/master/RSO/void.png)
...
**基于[若离仓库](https://github.com/thriving123/fuckTodayStudy)修改的今曰校园自动签到。**

> 备注: <u>配置文件格式与若离仓库不相同</u>

* 可以进行`签到`、`信息收集`、`查寝`、`政工签到`
* 详细功能（`正则`、`随机回答`、`代理`...）请参考[用户配置高级教程](documents/用户配置高级教程.md)
* 请在阅读声明后再查看[使用方法](documents/使用方法.md)
...
* 当脚本使用人数过多、过于张扬时，容易造成以下后果
  ...
  * 今曰校园更新密钥/接口/表单提交方式
  * 今曰校园的CDN华为云对IP进行封锁(具体表现为HTTP 418)
  * <u>公安局请你喝茶</u>
...
* 此处的代挂服务一般是指，班级、宿舍、亲友等小范围代挂。

* 本仓库禁止大规模提供代挂服务，不得宣传代挂服务(比如在论坛发布帖子等)。<u>不得以代挂服务吸引流量（比如以此引诱加群等）</u>
...
| 项目                   | 作用           | 参考成本                     | 必要性     |
| ---------------------- | -------------- | ---------------------------- | ---------- |
| 运行平台               | 运行脚本       | 腾讯云函数学生首年**1.08元** | 必要       |
| 代理                   | 避免脚本被屏蔽 | **2元**-60天-1000次使用      | 视情况     |
| 独立解决问题与解谜能力 | 解决问题       | （18年的读书与实践活动积累） | 必要       |
| 时间                   | 浪费           | 悲观预计需要一星期           | 必要       |
| 编程以及计算机基础     |                |                              | **不需要** |
...
* [致谢与推荐](documents/致谢与推荐.md)
* [开发者文档](documents/开发者文档.md)
* [更新与公告](documents/更新与公告.md)
* [Todo](documents/Todo.md)

## 更新公告

请参见[更新与公告](documents/更新与公告.md)

* **发现bug记得提交issue**
* **更新版本的时候请注意<u>更新公告</u>是否有<u>配置</u>的兼容性问题**
* **当使用文档里面描述的功能的时候，请检查已部署的代码版本<u>是否太旧没有新功能</u>**

### 近期公告

* 『2022-8-6公告』腾讯云函数日志开始收费，请在[此处](https://console.cloud.tencent.com/cls/overview)删除所有`日志主题`。并将所有云函数的函数配置中的`日志投递`取消。

  > <img src="documents/更新与公告.assets/2022-08-06-21-35-53-001.png" alt="2022-08-06-21-35-53-001" style="zoom: 80%;" />
